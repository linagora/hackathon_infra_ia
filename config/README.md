...
| File                                                 | Description                                 |
| ---------------------------------------------------- | ------------------------------------------- |
| [configuration.md](configuration.md)                 | `opencode.json` format, locations, all keys |
| [storage.md](storage.md)                             | SQLite, sessions, compaction, persistence   |
| [agents-md.md](agents-md.md)                         | AGENTS.md guide (project instructions)      |
| [providers.md](providers.md)                         | Custom LLM providers setup                  |
| [agents.md](agents.md)                               | Agent roles (build, plan, explore, etc.)    |
| [permissions.md](permissions.md)                     | Tool permissions (allow, ask, deny)         |
