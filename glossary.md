...
| **[Context window](config/context-window.md)**   | The maximum number of tokens a model can process in a single request (input + output).                                                          |
...
| **[Model](config/models.md)**                    | The LLM used for generation, specified as `provider/model-name`.                                                                                |
